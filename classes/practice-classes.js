...
class Player extends Character{
  ...
  defend(attack){    
    if(this.healthLevel -attack > 0){
      return {attackStrength: attack, remainingHealth: (this.healthLevel - attack), message: `${this.name} is still in the fight!`}  
      }
...
fireSpitter.addSuperPower('Ice breath')
fireSpitter.addSuperPower('Fly attack')
